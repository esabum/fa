    ...
    if($('.todo-list').length){
          ...
          var todoMenuContext = '<div id="context-menu" class="dropdown clearfix">'+
                              '<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">'+
                                '<li><a href="#" data-priority="high"><i class="far fa-circle c-red"></i> High Priority</a></li>'+
                                '<li><a href="#" data-priority="medium"><i class="far fa-circle c-orange"></i> Medium Priority</a></li>'+
                                '<li><a href="#" data-priority="low"><i class="far fa-circle c-yellow"></i> Low Priority</a></li>'+
                                '<li><a href="#" data-priority="none"><i class="far fa-circle c-gray"></i> None</a></li>'+
                              '</ul>'+
                            '</div>';
