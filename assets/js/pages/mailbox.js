if($('.page-content').hasClass('mailbox-send')){
    ...
    var emailMenuContext = '<div id="context-menu" class="email-context dropdown clearfix">'+
                      '<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">'+
                        '<li><a href="#" data-label="business" data-color="danger"><i class="far fa-circle c-red" data-label="business" data-color="danger"></i> Business</a></li>'+
                        '<li><a href="#" data-label="family" data-color="primary"><i class="far fa-circle c-blue" data-label="family" data-color="primary"></i> Family</a></li>'+
                        '<li><a href="#" data-label="friends" data-color="success"><i class="far fa-circle c-green" data-label="friends" data-color="success"></i> Friends</a></li>'+
                        '<li><a href="#" data-label="personal" data-color="warning"><i class="far fa-circle c-yellow" data-label="personal" data-color="warning"></i> Personal</a></li>'+
                        '<li><a href="#"><i class="far fa-circle c-gray"></i> No label</a></li>'+
                        '<li class="border-top"><a data-remove="true" href="#"><i class="fas fa-times"></i> Remove Email</a></li>'+
                      '</ul>'+
                    '</div>';
    $('.main-content').append(emailMenuContext);
    var $contextMenu = $("#context-menu");
