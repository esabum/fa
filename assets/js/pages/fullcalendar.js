function runCalendar() {
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        eventClick: function (calEvent, jsEvent, view) {
            ...
            form.append("<div class='input-group'><input class='form-control' type=text value='" + calEvent.title + "' /><span class='input-group-btn'><button type='submit' class='btn btn-success'><i class='fas fa-check'></i> Save</button></span></div>");
            $modal.modal({
                backdrop: 'static'
            });
    ...
    $('.save-category').on('click', function(){
        ...
        if (categoryName !== null && categoryName.length != 0) {
            $('#external-events').append('<div class="external-event bg-' + categoryColor + '" data-class="bg-' + categoryColor + '" style="position: relative;"><i class="fas fa-move"></i>' + categoryName + '</div>')
            runCalendar();
        }
