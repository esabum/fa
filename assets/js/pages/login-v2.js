...
$(function () {
    ...
    if ($('body').data('page') == 'login') {
        ...
        $('#submit-form').click(function (e) {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    if (data == 1) {
                        window.location.href = "/" + APPBASE + "index.php";
                    } else {
                        l.stop();
                        //jQuery("#login_status").html('&nbsp;<font color="#cc0000"><i class="fas fa-times-circle"></i>Error de autenticación. Intente de nuevo.</font>');
                        jQuery("#login_status").html('&nbsp;<font color="#cc0000">'+jQuery("#lblAuthError").val()+'</font>');
                        setTimeout(function () {
                            jQuery("#login_status").empty();
                        }, 5000);
                    }
                }
            });
        ...
        $('#submit-password').click(function (e) {
            ...
            jQuery.ajax({
                type: 'POST',
                url: '/' + APPBASE + 'selfservice/_email.php',
                data: {
                    username: jQuery('input#resetname').val(),
                },
                success: function (data) {
                    if (data == 1) {
                        l.stop();
