...
var root = src.split("Vista");
var LibURL = root[0];
//console.log(LibURL);
!function (e) {

    void 0 == e.fn.ajaxForm && e.getScript("/assets/plugins/upload/js/jquery.form.js");
    var a = {};
    a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function (t) {
        ...
        function f(a, t) {
            return this.statusbar = e("<div class='ajax-file-upload-statusbar'></div>").width(t.statusBarWidth), this.preview = e("<img class='ajax-file-upload-preview' />").width(t.previewWidth).height(t.previewHeight).appendTo(this.statusbar).hide(), this.filename = e("<div class='ajax-file-upload-filename'></div>").appendTo(this.statusbar), this.progressDiv = e("<div class='ajax-file-upload-progress'>").appendTo(this.statusbar).hide(), this.progressbar = e("<div class='ajax-file-upload-bar'></div>").appendTo(this.progressDiv), this.abort = e("<div><span class='glyphicon glyphicon-remove delIcon'></span></div>").appendTo(this.statusbar).hide(), this.cancel = e("<div><span class='glyphicon glyphicon-remove delIcon'></span></div>").appendTo(this.statusbar).hide(), this.done = e("<div>" + t.doneStr + "</div>").appendTo(this.statusbar).hide(), this.download = e("<div>" + t.downloadStr + "</div>").appendTo(this.statusbar).hide(), this.del = e("<div><span class='glyphicon glyphicon-remove delIcon'></span></div>").appendTo(this.statusbar).hide(), this.abort.addClass("cancel-icon"), this.done.addClass("ajax-file-upload-green"), this.download.addClass("ajax-file-upload-green"), /*this.cancel.addClass("ajax-file-upload-red"),*/ this.del.addClass("cancel-icon"),this.cancel.addClass("cancel-icon"), this;
        }
        ...
        var w = e.extend({
            ...
            dragDropStr: "<span><b>Arrastre aquí el certificado en formado.p12</b></span>",
            uploadStr: "Arrastre aquí el certificado en formato .p12",
            abortStr: "Anular",
            cancelStr: "Cancelar",
            deletelStr: "Eliminar",
            doneStr: "Hecho",
            multiDragErrorStr: "Arrastrar multiples archivos no es permitido.",
            extErrorStr: " no es permitido. Extensiones permitidas: ",
            duplicateErrorStr: " no es permitido. El archivo ya existe.",
            sizeErrorStr: " no es permitido. Tamaño máximo permitido: ",
            uploadErrorStr: "Upload is not allowed",
            maxFileCountErrorStr: " no es permitido. Archivos máximos permitidos: ",
