  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      picture: function (lang) {
        return tplIconButton('far fa-image', {
      ...
      table: function (lang) {
        var dropdown = '<ul class="note-table dropdown-menu">' +
                       ...
                       '</ul>';
        return tplIconButton('fas fa-table', {
      ...
      fullscreen: function (lang) {
        return tplIconButton('fas fa-arrows-alt-alt', {
          event: 'fullscreen',
    ...
    var tplPopovers = function (lang, options) {
      ...
      var tplImagePopover = function () {
        ...
        var circleButton = tplIconButton('far fa-circle', {
          title: lang.image.shapeCircle,
          event: 'imageShape',
          value: 'img-circle'
        });
        var thumbnailButton = tplIconButton('far fa-image', {
          title: lang.image.shapeThumbnail,
          event: 'imageShape',
          value: 'img-thumbnail'
        });
        var noneButton = tplIconButton('fas fa-times', {
          title: lang.image.shapeNone,
          event: 'imageShape',
          value: ''
        });

        var removeButton = tplIconButton('far fa-trash-alt', {
