    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[4].innerHTML = '<div class="text-center"><a class="edit btn btn-success" href="">Save</a> <a class="delete btn btn-danger" href=""><i class="fas fa-times-circle"></i> Remove</a></div>';
            }
            ...
            function saveRow(oTable, nRow) {
                ...
                oTable.fnUpdate('<div class="text-center"><a class="edit btn btn-dark" href=""><i class="far fa-edit"></i>Edit</a> <a class="delete btn btn-danger" href=""><i class="fas fa-times-circle"></i> Remove</a></div>', nRow, 4, false);
                oTable.fnDraw();
            }
            ...
            function cancelEditRow(oTable, nRow) {
                ...
                oTable.fnUpdate(jqInputs[2].value, nRow, 2, false);
                oTable.fnUpdate(jqInputs[3].value, nRow, 3, false);
                oTable.fnUpdate('<a class="edit btn btn-dark" href=""><i class="far fa-edit"></i>Edit</a>', nRow, 4, false);
                oTable.fnDraw();
            }
